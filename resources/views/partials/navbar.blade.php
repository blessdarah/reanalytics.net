    ...
    <div class="max-w-7xl border-none relative border-gray-200 mx-auto flex w-full justify-between items-center">
        ...
        <div id="menu" class="absolute md:relative md:w-auto border md:rounded-none items-center rounded-xl md:py-0 py-5 md:shadow-none shadow-xl border-gray-200 md:border-transparent w-full hidden z-20 md:flex md:bg-transparent md:top-auto top-0 md:mt-0 mt-20 bg-white">
            <nav class="md:space-x-6 lg:space-x-12 flex md:flex-row flex-col h-full font-medium">
                ...
                <a href="{{route('services')}}" class="md:w-auto w-full md:py-0 py-3 text-center">Services</a>
                <a href="{{route('blog')}}" class="md:w-auto w-full md:py-0 py-3 text-center">Blog</a>
                <a href="{{route('about')}}" class="md:w-auto w-full md:py-0 py-3 text-center">About</a>
            </nav>
            ...
            <div class="h-full font-medium flex items-center md:flex-row flex-col md:pl-6 lg:pl-10">
                <a href="{{route('contact')}}" class="md:w-auto w-full text-center md:py-0 py-3">Contact us</a>
                <a href="{{route('login')}}" class="px-5 md:mr-0 mr-5 ml-5 text-center lg:ml-7 py-3 border-2 border-gray-900 hover:text-gray-100 hover:bg-gray-900 transition-colors ease-out duration-100 rounded-xl">Admin Login</a>
            </div>
        </div>
