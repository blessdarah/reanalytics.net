        ...
        <div class="grid gap-5 lg:grid-cols-2">
            <div class="flex flex-col justify-center md:pr-8 xl:pr-0 lg:max-w-lg">
                ...
                <div class="max-w-xl mb-6">
                    <div class="mb-6">
                        <p class="inline font-sans text-5xl font-bold tracking-tight text-gray-900 sm:text-6xl sm:leading-none">Beautiful designs </p>
                        <p class="block font-sans text-5xl font-bold tracking-tight text-purple-700 sm:text-6xl sm:leading-none">to help you shine.</p>
                    </div>
                    <p class="text-base text-gray-700 md:text-lg">We have hand-crafted beautiful designs that will help your product or service shine. Drag'n drop templates that allow you to build amazing landing pages in seconds!</p>
                </div>
                <div class="max-w-xl mb-6">
                    <p class="relative">
